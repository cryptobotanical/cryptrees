          ...
          <div className="container relative mx-auto">
            <div className="items-center flex flex-wrap">
              <div className="w-full lg:w-8/12 px-4 ml-auto mr-auto text-center">
                <div className="pr-12">
                  <h1 className="text-slate-500 font-semibold text-5xl">
          ...
          <div className="container mx-auto px-4">
              ...
              <div className="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-zinc-800 w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    <div className="text-zinc-700 p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full bg-indigo-400">
              ...
              <div className="pt-6 w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-zinc-800 w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <h6 className="text-xl font-semibold">Positive Investment</h6>
                    <p className="mt-2 mb-4 text-slate-500">
                      By promoting <Logo weight={500} /> to encourage conservationship, your investment
                      of owning <Logo weight={500} /> is also increased through a positive cycle of
                      win-win reinforcement.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-wrap items-center mt-32">
              <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
                <div className="text-slate-500 p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-zinc-800">
