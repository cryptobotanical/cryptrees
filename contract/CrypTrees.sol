...
// File contracts/access/Paid.sol
...
// File contracts/interfaces/IERC165.oz.sol
...
// File contracts/access/OperatorFilterer.sol
...
// File contracts/tokens/ERC721/ERC721A.chiru.sol
...
// File contracts/access/ConstructorInitializable.sol
...
// File contracts/access/TwoStepOwnable.sol
...
// File contracts/tokens/ERC721/extensions/ERC721AContractMetadata.sol
...
// File contracts/tokens/ERC721/extensions/ERC721ASeadrop.sol
    ...
    OpenSeaDefaultOperatorFilterer
{
    ...
    ) ERC721AContractMetadata(name_, symbol_) {
    ...
    function getMintStats(address minter)
        ...
        returns (
            ...
            uint256 currentTotalSupply_,
            uint256 maxSupply_
        )
    {
        minterNumMinted_ = _numberMinted(minter);
        currentTotalSupply_ = _totalMinted();
    ...
    Paid 
{
    ...
    function mint() external payable {
        if (msg.value < OPEN_MINT_PRICE) 
            revert IncorrectPayment(msg.value, OPEN_MINT_PRICE);
    ...
    function _mintGuard(
        ...
        if(quantity_ > MAX_PER_TX)
            revert MintQuantityExceedsTransactionLimit(quantity_, MAX_PER_TX);
